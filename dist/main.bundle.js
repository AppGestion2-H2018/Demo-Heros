...
var HerosComponent = /** @class */ (function () {
    ...
    HerosComponent.prototype.onAdd = function (tableHeros, newHeroForm) {
        var _this = this;
        console.log("123");
        ...
        if (newHeroForm.valid) {
            this.heroService.addHero(this.newHero)
                .subscribe(function (hero) { _this.heros.push(hero); newHeroForm.resetForm(); tableHeros.renderRows(); });
        }
    };

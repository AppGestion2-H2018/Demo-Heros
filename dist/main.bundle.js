...
var HerosComponent = /** @class */ (function () {
    ...
    HerosComponent.prototype.onAdd = function (tableHeros, heroFormAjout) {
        var _this = this;
        console.log("123");
        ...
        if (heroFormAjout.valid) {
            this.heroService.addHero(this.newHero)
                .subscribe(function (hero) { _this.heros.push(hero); heroFormAjout.resetForm(); tableHeros.renderRows(); });
        }
    };
    HerosComponent.prototype.onSelected = function (hero) {
        this.selectedHero = hero;
    };
    HerosComponent.prototype.onEdit = function (heroFormEdition) {
        var _this = this;
